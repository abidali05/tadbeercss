...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="apple-touch-icon" href="app/images/apple-touch-icon-57x57.png">
        ...
        <link rel="stylesheet" type="text/css" href="app/css/font-icons.min.css">
        <link rel="stylesheet" type="text/css" href="app/css/theme-vendors.min.css">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row">
                    <div class="col-12 tab-style-01 without-number wow animate__fadeIn">
                        ...
                        <ul class="nav nav-tabs text-uppercase justify-content-center text-center alt-font font-weight-500 margin-7-rem-bottom md-margin-5-rem-bottom sm-margin-20px-bottom">
                            <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#planning-tab">Planning</a><span class="tab-border bg-extra-dark-gray"></span></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#research-tab">Research</a><span class="tab-border bg-extra-dark-gray"></span></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#target-tab">Target</a><span class="tab-border bg-extra-dark-gray"></span></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#campaign-tab">Campaign</a><span class="tab-border bg-extra-dark-gray"></span></li>
                        </ul>
                        <!-- end tab navigation -->
        ...
        <section class="bg-light-blue">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <!-- end feature box item -->
                    <!-- start feature box item -->
                    <div class="col-12 col-lg-6 col-md-9 margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        <div class="feature-box h-100 feature-box-left-icon border-radius-5px bg-white box-shadow-small box-shadow-extra-large-hover overflow-hidden padding-4-rem-all">
                            <div class="feature-box-icon">
                    ...
                    <!-- end feature box item -->
                    <!-- start feature box item -->
                    <div class="col-12 col-lg-6 col-md-9 md-margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                        <div class="feature-box h-100 feature-box-left-icon border-radius-5px bg-white box-shadow-small box-shadow-extra-large-hover overflow-hidden padding-4-rem-all">
                            <div class="feature-box-icon">
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 client-logo-style-05">
                    ...
                    <div class="col text-center md-margin-40px-bottom xs-margin-50px-bottom wow animate__fadeIn">
                        <a href="#"><img src="https://via.placeholder.com/300x86" alt="" class="w-57"></a>
                    </div>
        ...
        <script type="text/javascript" src="app/js/theme-vendors.min.js"></script>
